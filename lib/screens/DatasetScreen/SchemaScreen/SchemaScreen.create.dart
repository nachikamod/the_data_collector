                  ...
                  Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        initialValue:
                            _formSchema[index]['max_length']?.toString(),
                        onChanged: (value) {
                          setState(() {
                            try {
                              _formSchema[index]['max_length'] =
                      ...
                      TextFormField(
                        onSaved: (value) {
                          setState(() {
                            _formSchema[index]['regexp'] = value;
                          });
                        },
                        initialValue: _formSchema[index]['regexp'],
                        onChanged: (value) {
                          setState(() {
                            _formSchema[index]['regexp'] = value;
                          });
                  ...
                  Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        initialValue:
                        _formSchema[index]['min_value']?.toString(),
                        onChanged: (value) {
                          setState(() {
                            try {
                              _formSchema[index]['min_value'] =
                      ...
                      TextFormField(
                        ...
                        initialValue:
                        _formSchema[index]['max_value']?.toString(),
                        onChanged: (value) {
                          setState(() {
                            try {
                              _formSchema[index]['max_value'] =
